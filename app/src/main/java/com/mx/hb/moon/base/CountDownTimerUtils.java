...
public class CountDownTimerUtils extends CountDownTimer {
    ...
    public void onTick(long millisUntilFinished) {
        ...
        mTextView.setBackgroundResource(R.drawable.bg_edittext_code2); //设置按钮为灰色，这时是不能点击的
    ...
    public void onFinish() {
        ...
        mTextView.setBackgroundResource(R.drawable.bg_edittext_code1);  //还原背景色
