 ...
 */
public class CashDAdapter extends BaseExpandableListAdapter {
    private Context context;
    private LayoutInflater inflater = null;
    private List<Map<String, Object>> parents;
    private List<List<Map<String, Object>>> childs;
    public CashDAdapter(Context context) {
    ...
    public View getChildView(int groupPosition, int childPosition, boolean isLastChild, View convertView, ViewGroup parent) {
        ...
        String aTime = (String) childs.get(groupPosition).get(childPosition).get("aDate");
        String stateName = (String) childs.get(groupPosition).get(childPosition).get("stateName");
        if(TextUtils.equals("提现失败",stateName)){
            holder.ECContent.setText(
                    "提现状态："+Html.fromHtml("<font>"+childs.get(groupPosition).get(childPosition).get("stateName")+"</font>")+"\n"+"\n"+
                            "订单说明："+Html.fromHtml("<font>"+childs.get(groupPosition).get(childPosition).get("remark")+"</font>")+"\n"+"\n"+
                            "提现编号："+Html.fromHtml("<font>"+childs.get(groupPosition).get(childPosition).get("num")+"</font>")+"\n"+"\n"+
                            "支付宝账号："+Html.fromHtml("<font>"+childs.get(groupPosition).get(childPosition).get("zfb")+"</font>")+"\n"+"\n"+
                            "支付宝姓名："+Html.fromHtml("<font>"+childs.get(groupPosition).get(childPosition).get("zfbName")+"</font>")+"\n"+"\n"+
                            "提现时间："+Html.fromHtml("<font>"+childs.get(groupPosition).get(childPosition).get("cDate")+"</font>")+"\n"+"\n"+
                            "处理时间："+Html.fromHtml("<font>"+childs.get(groupPosition).get(childPosition).get("aDate")+"</font>")
            );
        } else {
            if(TextUtils.equals("0",aTime)){
                holder.ECContent.setText(
                        "提现状态："+Html.fromHtml("<font>"+childs.get(groupPosition).get(childPosition).get("stateName")+"</font>")+"\n"+"\n"+
                                "订单说明："+Html.fromHtml("<font>"+childs.get(groupPosition).get(childPosition).get("remark")+"</font>")+"\n"+"\n"+
                                "提现编号："+Html.fromHtml("<font>"+childs.get(groupPosition).get(childPosition).get("num")+"</font>")+"\n"+"\n"+
                ...
                holder.ECContent.setText(
                        "提现状态："+Html.fromHtml("<font>"+childs.get(groupPosition).get(childPosition).get("stateName")+"</font>")+"\n"+"\n"+
                                ...
                                "支付宝姓名："+Html.fromHtml("<font>"+childs.get(groupPosition).get(childPosition).get("zfbName")+"</font>")+"\n"+"\n"+
                                "提现时间："+Html.fromHtml("<font>"+childs.get(groupPosition).get(childPosition).get("cDate")+"</font>")+"\n"+"\n"+
                                "到账时间："+Html.fromHtml("<font>"+childs.get(groupPosition).get(childPosition).get("aDate")+"</font>")
                );
            }
        }
        return convertView;
