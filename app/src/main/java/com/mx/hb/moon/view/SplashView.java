...
/**
 * Created by superMoon on 2017/3/20.
 */
...
public class SplashView extends FrameLayout {
    ...
    void initComponents() {
        ...
        skipButtonLayoutParams.gravity = Gravity.BOTTOM| Gravity.RIGHT;
        ...
        skipButtonLayoutParams.setMargins(0, 0, skipButtonMargin, skipButtonMargin);
